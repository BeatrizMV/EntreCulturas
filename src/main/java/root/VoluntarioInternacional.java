...
public class VoluntarioInternacional extends MiembroEquipo {
     ...
     */
    public VoluntarioInternacional(int idPersona, String dni, String nombre, String apellido1, String apellido2, Direccion direccion, int telefono, String email, String usuario, String password, Rol rol) {
