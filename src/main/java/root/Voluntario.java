...
public class Voluntario extends MiembroEquipo{
     ...
     */
    public Voluntario (int idPersona, String dni, String nombre, String apellido1, String apellido2, Direccion direccion, int telefono, String email, String usuario, String password, Rol rol){
